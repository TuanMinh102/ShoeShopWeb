        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    ...
                    <li class="active"><a href="ct">Product</a></li>
                ...
                <div class="row">
                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">                                 
                                    ...
                                    <div style="width:100px;height: 100px;">
                                        <a href="ct{{$row->MaGiay}}"><img src="img/bg-img/{{$row->Anh}}"></a>
                                    </div>
                                    @endforeach
                                </ol>
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="img/bg-img/{{$row->Anh}}">
                                            <img class="d-block w-100" src="img/bg-img/{{$row->Anh}}" alt="">
                                        </a>
                                    </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <!-- Add to Cart Form -->
                            <form class="cart clearfix" method="get" action="gh{{$row->MaGiay}}">
                                <div class="cart-btn d-flex mb-50">
                                    <p>Qty</p>
                                    <div class="quantity">
                                        <span class="qty-minus" onclick="var effect = document.getElementById('qty'); var qty = effect.value; if( !isNaN( qty ) &amp;&amp; qty &gt; 1 ) effect.value--;return false;"><i class="fa fa-caret-down" aria-hidden="true"></i></span>
                                        <input type="number" class="qty-text" id="qty" step="1" min="1" max="{{$row->SoLuong}}" name="quantity" value="1">
